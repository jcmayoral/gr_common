#include <gr_safety_policies/safe_actions/service_caller_safe_action.h>
#include <pluginlib/class_list_macros.h>

PLUGINLIB_EXPORT_CLASS(gr_safety_policies::ServiceCallerSafeAction,safety_core::SafeAction);
